...
** they can take on multiple conformations
...
.Energy Comparison
Stop if the change in energy  between this step and the previous is below a threshold
...
* assuming 10 degree steps => 36 steps
* 7 bonds -> stem:[36^{7} \cdot 4 \rightarrow \gt 300,000,000,000] combinations
** the 4 accounts for 4 ring conformations (assuming this molecule has a ring)
